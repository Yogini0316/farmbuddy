...
<body>
    ...
    <div id="main">
        ...
        <section class="section-seeds">
            <h1 class="section-heading">Seeds</h1>
            <!-- product fetcher begins -->
            <div class="products-fetcher">
                <!-- product card begins apply php code here -->
                <?php
                    $result = mysqli_query($db, "SELECT * FROM products WHERE type='seeds' limit 4");
            ...
            <div class="see-more">
                <a href="seeds.php">See More <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
            </div>
        </section>
        <section class="section-herbicides">
            ...
            <div class="products-fetcher">
                <!-- product card begins apply php code here -->
                <?php
                    $result = mysqli_query($db, "SELECT * FROM products WHERE type='protectors' limit 4");
            ...
            <!-- end of product fetcher -->
            <div class="see-more">
                <a href="herbicides.php">See More <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
            </div>
        </section>
        <section class="section-pesticides">
            <h1 class="section-heading">Fungicides</h1>
            <!-- product fetcher begins -->
            <div class="products-fetcher">
                <!-- product card begins apply php code here -->
                <?php
                    $result = mysqli_query($db, "SELECT * FROM products WHERE type='pesticide'limit 4");
                    ...
                    {?>
                        <div class="product-card p-2">
                            ...
                            <strong><p class="product-name"><?php echo $row['name'];?></p></strong>
                            <p> &#8377; <?php echo $row['price'];?></p>
                            <form action="add_to_cart.php" method="POST">
                        Quantity : <input class="form-control my-1" type="number" min="1" name="qty"
                            placeholder="Quantity" value="1">
                    ...
                    <?php }
                ?>
                <!-- end of product card place product card in for loop -->
            </div>  
            <div class="see-more">
                <a href="fungicides.php">See More <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
            </div> 
        </section>

        <section class="section-protector">
            <h1 class="section-heading">Insecticides</h1>
            <!-- product fetcher begins -->
            <div class="products-fetcher">
                <!-- product card begins apply php code here -->
                <?php
                    $result = mysqli_query($db, "SELECT * FROM products WHERE type='protector' limit 4");
            ...
            <div class="see-more">
                <a href="insecticides.php">See More <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
            </div>   
        </section>

  
        <section class="section-nutrients">
            <h1 class="section-heading">Fertilizers</h1>
            <!-- product fetcher begins -->
            <div class="products-fetcher">
                <!-- product card begins apply php code here -->
                <?php
                    $result = mysqli_query($db, "SELECT * FROM products WHERE type='nutrients' limit 4");
            ...
            <!-- end of product fetcher -->
            <div class="see-more">
                <a href="fertilizers.php">See More <i class="fa fa-angle-right"></i><i
